...
<body>
    ...
    <div>
        Total Number of Movies: <asp:Label ID="TotalMovies" runat="server" Text="Label"></asp:Label><br />
        Longest Runtime: <asp:Label ID="LongestRuntime" runat="server" Text="Label"></asp:Label><br />
        Shortest Runtime: <asp:Label ID="ShortestRuntime" runat="server" Text="Label"></asp:Label><br />
        Average Runtime: <asp:Label ID="AverageRuntime" runat="server" Text="Label"></asp:Label><br />
    </div>
    </form>
</body>
</html>
