...
Namespace Migrations
    Public NotInheritable Partial Class TeamPlayerRelationship
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(TeamPlayerRelationship))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201210230329534_TeamPlayerRelationship"
            End Get
        End Property
