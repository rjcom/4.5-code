...
namespace CS.EF
{
    ...
    /// </summary>
    public partial class NorthwindCSEntities : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new NorthwindCSEntities object using the connection string found in the 'NorthwindCSEntities' section of the application configuration file.
        /// </summary>
        public NorthwindCSEntities() : base("name=NorthwindCSEntities", "NorthwindCSEntities")
        {
        ...
        /// <summary>
        /// Initialize a new NorthwindCSEntities object.
        /// </summary>
        public NorthwindCSEntities(string connectionString) : base(connectionString, "NorthwindCSEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new NorthwindCSEntities object.
        /// </summary>
        public NorthwindCSEntities(EntityConnection connection) : base(connection, "NorthwindCSEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="NorthwindCSModel", Name="Customer")]
    [Serializable()]
